...
public class Main {
    public static void main(String[] args) {
        Cat cat1 = new Cat("Барсик", "green",LocalDate.of(2018,1,20));
        Cat cat2 = new Cat("Барсик", "green",LocalDate.of(2018,1,20));
        Cat cat3 = new Cat("Барсик", "green",LocalDate.of(2018,1,20));
